...
using namespace std;
int main(){
   vector<int> sortedarray = {6, 15, 21,21,21, 27, 39, 42};
   ...
   // else
   //    cout<<"The element is not found";
    cout<<lower_bound(sortedarray.begin(), sortedarray.end(), 21)- sortedarray.begin();
    cout<<upper_bound(sortedarray.begin(), sortedarray.end(), 21)- sortedarray.begin();
}